% 9th Oct 2021 ENEL.m for reading EX4 raw data file from EMPIRE output 
...
%ReacMT='#MT         1';% this should be user input 
 ...
 % lpha-K
%FileID='D:\Empire3.2.2\EMPIRE-3.2.2\EXFOR\alphas\010_Ne_022.c4';
...
[EC4,Auth,E,DE,CrsSec,DCrsSec,IndxSelect,Mindx]=plotC4data(Indx,OutInf,...
    CSC4,ReacMF,ReacMT);
 % END of the ENEL code! 